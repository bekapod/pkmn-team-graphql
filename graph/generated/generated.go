...
type ComplexityRoot struct {
	...
	Query struct {
		AllMoves   func(childComplexity int) int
		AllPokemon func(childComplexity int) int
		AllTypes   func(childComplexity int) int
	}
...
type QueryResolver interface {
	...
	AllTypes(ctx context.Context) (*model.TypeList, error)
	AllMoves(ctx context.Context) (*model.MoveList, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Query.allMoves":
		if e.complexity.Query.AllMoves == nil {
			break
		}

		return e.complexity.Query.AllMoves(childComplexity), true
	...
	case "Query.allTypes":
		if e.complexity.Query.AllTypes == nil {
			break
		}

		return e.complexity.Query.AllTypes(childComplexity), true
...
func (ec *executionContext) _Query_allTypes(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().AllTypes(rctx)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Query_allMoves(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().AllMoves(rctx)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	for i, field := range fields {
		...
		case "allTypes":
			...
			out.Concurrently(i, func() (res graphql.Marshaler) {
				...
				res = ec._Query_allTypes(ctx, field)
				if res == graphql.Null {
					atomic.AddUint32(&invalids, 1)
				}
				return res
		...
		case "allMoves":
			...
			out.Concurrently(i, func() (res graphql.Marshaler) {
				...
				res = ec._Query_allMoves(ctx, field)
				if res == graphql.Null {
					atomic.AddUint32(&invalids, 1)
				}
				return res
